...
1. Download **[WebsiteHealthManager-Setup-0.1.9.exe](https://github.com/Pieter1821/Website-Health-Manager/releases/download/v0.1.9/WebsiteHealthManager-Setup-0.1.9.exe)** from the [latest release](https://github.com/Pieter1821/Website-Health-Manager/releases/latest).
